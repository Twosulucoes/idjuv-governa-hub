    ...
    items: [
      {
        ...
        href: "/admin/perfis",
        icon: Shield,
        keywords: ["perfis", "permissões", "funções", "acesso", "roles", "matriz"],
      },
      {
        id: "aprovacoes",
        ...
        icon: FileCheck,
        keywords: ["aprovações", "pendências", "autorização"],
      },
      {
        id: "auditoria",
        label: "Auditoria",
        ...
        icon: Eye,
        keywords: ["auditoria", "logs", "histórico", "ações"],
      },
      {
        id: "controle-acesso",
      ...
      },
      {
        ...
        href: "/admin/backup",
        icon: Database,
        keywords: ["backup", "restauração", "segurança", "offsite"],
      },
      {
