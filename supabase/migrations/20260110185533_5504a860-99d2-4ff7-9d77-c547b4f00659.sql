-- Corrigir função fn_atualizar_situacao_servidor com valores corretos do enum categoria_cargo
...
BEGIN
  ...
  IF EXISTS (
    ...
    -- Atualizar tipo_servidor baseado no provimento (usando valores corretos do enum)
